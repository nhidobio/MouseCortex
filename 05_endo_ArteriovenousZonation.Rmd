...
```{r BIOLOGICAL INTERPRETATION}
# # Young
# transporting_y <- endo_corrected_20dim_red_young[,endo_corrected_20dim_red_young$cluster_labels%in%c("Transporting BEC")]
# migrative_y <- endo_corrected_20dim_red_young[,endo_corrected_20dim_red_young$cluster_labels%in%c("Migrative BEC")]
# oxphos_y <- endo_corrected_20dim_red_young[,endo_corrected_20dim_red_young$cluster_labels%in%c("OXPHOS BEC")]
# 
# table(transporting_y$arteriovenous_clustering)
# table(migrative_y$arteriovenous_clustering)
# table(oxphos_y$arteriovenous_clustering)
# 
# # Old
# transporting_o <- endo_corrected_20dim_red_old[,endo_corrected_20dim_red_old$cluster_labels%in%c("Transporting BEC")]
# migr202135ative_o <- endo_corrected_20dim_red_old[,endo_corrected_20dim_red_old$cluster_labels%in%c("Migrative BEC")]
# oxphos_o <- endo_corrected_20dim_red_old[,endo_corrected_20dim_red_old$cluster_labels%in%c("OXPHOS BEC")]
# 
# table(transporting_o$arteriovenous_clustering)
# table(migrative_o$arteriovenous_clustering)
# table(oxphos_o$arteriovenous_clustering)
```
